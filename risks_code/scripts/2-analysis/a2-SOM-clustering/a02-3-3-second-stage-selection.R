...
win_iter = 120  # selected from winning models as hierarchical clusters group nicely for narrative development
...
som2_model <- readRDS(here("data/som_files/som_selection/som2_selection_26.rds"))
