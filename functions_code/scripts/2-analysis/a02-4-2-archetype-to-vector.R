...
watersheds <- vect(here("data/input//wfunctions_gr_ready.gpkg"))

# 2. Load the CSV file containing prototype and archetype assignments
id_lookup <- read_csv(here("data/output/water_SES_functions_archetypes.csv"))
...
writeVector(watersheds, here("data/output/wfunctions_archetypes.gpkg"), overwrite = TRUE)
