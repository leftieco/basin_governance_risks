...
# 1. Load SOM models
# ---------------------------------------------------------
som1_model <- read_rds(here("data/som_files/som_files_full/som1_nrc_38_iter_56.rds"))
...
# ---------------------------------------------------------
watersheds <- terra::vect(here("data/input/wfunctions_gr_ready.gpkg"))
...
prot_to_arch <- tibble(
  ...
  # ---------------------------------------------------------
  out_path <- here("data/output/water_SES_functions_archetypes.csv")
